...
{
    class DistanceDiffToPowerAction : IAction
    {
#if !ST_2_1
        public DistanceDiffToPowerAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public DistanceDiffToPowerAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public DistanceDiffToPowerAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return Properties.Resources.Edit_DistanceDiffToPower_Text; }
        }
        public bool Visible
        {
            get
