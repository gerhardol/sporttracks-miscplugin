...
{
    class DetectRestLapsAction : IAction
    {
#if !ST_2_1
        public DetectRestLapsAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public DetectRestLapsAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public DetectRestLapsAction(IList<IActivity> activities)
        {
       ...
       public bool Enabled
        ...
        public string Title
        {
            get { return Properties.Resources.Edit_DetectRestLaps_Text; }
        }
        public bool Visible
        {
            get
            {
                if (!MiscPlugin.Plugin.DetectRestLapsEditMenu) return false;
