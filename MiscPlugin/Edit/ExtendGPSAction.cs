...
{
    class ExtendGPSAction : IAction
    {
#if !ST_2_1
        public ExtendGPSAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public ExtendGPSAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public ExtendGPSAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return Properties.Resources.Edit_ExtendGPS_Text; }
        }
        public bool Visible
        {
            get
