...
{
    class FixNaNAction : IAction
    {
#if !ST_2_1
        public FixNaNAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public FixNaNAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public FixNaNAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return Properties.Resources.Edit_FixNaN_Text; }
        }
        public bool Visible
        {
            get
            {
                if (!MiscPlugin.Plugin.FixNaNEditMenu) return false;
