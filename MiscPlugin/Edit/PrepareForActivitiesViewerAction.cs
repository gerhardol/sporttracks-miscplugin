...
{
    class PrepareForActivitiesViewerAction : IAction
    {
#if !ST_2_1
        public PrepareForActivitiesViewerAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public PrepareForActivitiesViewerAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public PrepareForActivitiesViewerAction(IList<IActivity> activities)
        {
