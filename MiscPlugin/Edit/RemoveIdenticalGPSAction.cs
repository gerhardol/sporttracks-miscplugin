...
{
    class RemoveIdenticalGPSAction : IAction
    {
#if !ST_2_1
        public RemoveIdenticalGPSAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public RemoveIdenticalGPSAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public RemoveIdenticalGPSAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return Properties.Resources.Edit_RemoveIdenticalGPS_Text; }
        }
        public bool Visible
        {
            get
