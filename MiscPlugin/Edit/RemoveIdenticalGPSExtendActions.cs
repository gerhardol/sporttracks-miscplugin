...
{
#if ST_2_1
    class RemoveIdenticalGPSExtendActions : IExtendActivityEditActions
#else
    class RemoveIdenticalGPSExtendActions : IExtendDailyActivityViewActions, IExtendActivityReportsViewActions
#endif
    {
        ...
        IList<IAction> IExtendActivityEditActions.GetActions(IList<IActivity> activities)
        {
            ...
            if (!MiscPlugin.Plugin.RemoveIdenticalGPSEditMenu) return null;
            ...
            return new IAction[] {
                new RemoveIdenticalGPSAction(activities2)
            };
        }
        ...
        IList<IAction> IExtendActivityEditActions.GetActions(IActivity activity)
        {
            ...
            IList<IActivity> activities2 = new List<IActivity>();
            activities2.Add(activity);
            return new IAction[] { new RemoveIdenticalGPSAction(activities2) };
        }
        #endregion
#else
                                                 ...
                                                 ExtendViewActions.Location location)
        {
            ...
            {
                return new IAction[] { new RemoveIdenticalGPSAction(view) };
            }
