...
{
    class SetCategoryExtendAction : IAction
    {
#if !ST_2_1
        public SetCategoryExtendAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public SetCategoryExtendAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public SetCategoryExtendAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return "Set Category from Metadata"; }//xxx Properties.Resources.Edit_SetCategory_Text; }
        }
        public bool Visible
        {
            get
