...
{
    class SetMetadataExtendAction : IAction
    {
#if !ST_2_1
        public SetMetadataExtendAction(IDailyActivityView view)
        {
            this.dailyView = view;
        }
        public SetMetadataExtendAction(IActivityReportsView view)
        {
            this.reportView = view;
        }
#endif
        public SetMetadataExtendAction(IList<IActivity> activities)
        {
        ...
        public string Title
        {
            get { return "Fix metadata"; }//xxx Properties.Resources.Edit_SetMetadata_Text; }
        }
        public bool Visible
        {
            get
