...
namespace MiscPlugin.Edit
{
...
#endif
    {
        ...
        //    if (!MiscPlugin.Plugin.SetUseEnteredDataEditMenu) return null;
        ...
        //    return new IAction[] {
        //        new SetUseEnteredDataAction(routes2)
        //    };
        //}
        ...
        //   IList<IRoute> routes2 = new List<IRoute>();
        //   routes2.Add(route);
        //   return new IAction[] { new SetUseEnteredDataAction(routes2) };
        //}
        #endregion
        ...
        IList<IAction> IExtendActivityEditActions.GetActions(IList<IActivity> activities)
        {
            ...
            return new IAction[] {
                new SetUseEnteredDataAction(activities2)
            };
        }
        ...
        IList<IAction> IExtendActivityEditActions.GetActions(IActivity activity)
        {
           ...
           IList<IActivity> activities2 = new List<IActivity>();
           activities2.Add(activity);
           return new IAction[] { new SetUseEnteredDataAction(activities2) };
        }
        #endregion
#else
